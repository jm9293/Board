        ...
        <form action="writeprogress.php" method="post">
            <div class="col-12">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="title" name="title" placeholder="제목을 입력하세요 (20자이내)"
                        maxlength="20">
            ...
            <div class="col-12">
                <div class="mb-3">
                    ...
                    <textarea class="form-control text" placeholder="내용을 입력해주세요 (300자 이하)" id="text" name="text"
                ...
                <div class="mb-3">
                    ...
                    <input type="password" class="form-control" id="writepassword" name="password"
                        placeholder="비밀번호를 입력하세요. (10자이내)" maxlength="10">
                    <div class="invalid-feedback">
                        비밀번호를 입력해주세요.
                    </div>
                </div>
                <div class="mb-3">
                    ...
                    <input type="password" class="form-control" id="writepasswordChk" name="passwordChk"
                        placeholder="한번더 입력하세요." maxlength="20">
                    <div class="invalid-feedback">
                        동일한 비밀번호를 입력해주세요.
                    </div>
                </div>
